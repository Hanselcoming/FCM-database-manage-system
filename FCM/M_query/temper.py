...
class Ui_MainWindow(QMainWindow):
    ...
    def new(self):
        ...
        result = service.query2("select * from v_temper")  # 调用服务类中的公共方法执行查询语句
    ...
    def Query(self):
        try:
            ...
            #     QMessageBox.warning(None, '警告', '请检查所要查询的数据最小最大值！', QMessageBox.Ok)
                ...
                result1 = service.choose(ingzavg_min, ingzavg_max, '抗高温老化性质表', '老化D50降级')  # 按照密度查询
                a = service.exec2("alter table t_temp rename to t_temp_1")
                if a>0:
                    result2 = service.choose(inyjavg_min, inyjavg_max, 't_temp_1', '老化D90降级')  # 按照D50查询
                    b=service.exec2("alter table t_temp rename to t_temp_2")
                    if b>0:
                        result3 = service.choose(ingzmax_min, ingzmax_max, 't_temp_2', '老化压后D50降级')  # 按照D90查询
                        c=service.exec2("alter table t_temp rename to t_temp_3")
                        if c>0:
                            result4 = service.choose(inyjmax_min, inyjmax_max, 't_temp_3','老化压后D90降级')  # 按照长径比查询
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "按抗高温能力查询"))
        self.label.setText(_translate("MainWindow",
                                      "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt;\">按抗高温老化性质查询</span></p></body></html>"))
