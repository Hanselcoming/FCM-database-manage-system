...
class Ui_MainWindow(QMainWindow):
    ...
    def query(self):
        ...
        result = service.query("select * from 抗磨蚀能力表")  # 调用服务类中的公共方法执行查询语句
    ...
    def getName(self, name):
        result = service.query("select * from 抗磨蚀能力表 where 编号= %s", name)
        return len(result)
            ...
            if inbh != "":  # 判断编号不为空
                if self.getName(inbh) > 0:
                    ...
                    if service.getName(inbh) == 0:
                        ...
                        result = service.exec("insert into 抗磨蚀能力表(编号,D50降级,D90降级,级别) values (%s,%s,%s,%s)",
        ...
        try:
            ...
            if inbh != "":  # 判断编号不为空
                if self.getName(inbh) <= 0:
                    ...
                    result = service.exec("update 抗磨蚀能力表 set D50降级= %s,D90降级=%s,级别=%s where 编号=%s",
        ...
        try:
            ...
            if inbh != "":
                if self.getName(inbh) <= 0:  # 判断编号是否存在
                    ...
                    result = service.exec("delete from 抗磨蚀能力表 where 编号= %s", (inbh,))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "材料按抗磨蚀能力管理"))
