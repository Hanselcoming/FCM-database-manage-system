...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.in50, 2, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.inxz, 1, 3, 1, 2)
    ...
    def query(self):
        ...
        result = service.query("select * from 摩擦系数表")  # 调用服务类中的公共方法执行查询语句
    ...
    def getName(self, name):
        result = service.query("select * from 摩擦系数表 where 编号= %s", name)
        return len(result)
            ...
            if inbh != "":  # 判断编号不为空
                ...
                #     QMessageBox.information(None, '提示', '您要添加的材料必须先在基本信息表中添加编号！', QMessageBox.Ok)
                    ...
                    if service.getName(inbh) == 0:
                        ...
                        result = service.exec(
                            "insert into 摩擦系数表(编号,dry_avg,oil_based_avg,dry_max_s,oil_based_max,级别) values (%s,%s,%s,%s,%s,%s)",
        ...
        try:
            ...
            if inbh != "":  # 判断编号不为空
                if self.getName(inbh) <= 0:
                    ...
                    result = service.exec(
                        "update 摩擦系数表 set dry_avg=%s,oil_based_avg=%s,dry_max_s=%s,oil_based_max=%s,级别=%s where 编号=%s",
        ...
        try:
            ...
            if inbh != "":
                if self.getName(inbh) <= 0:  # 判断编号是否存在
                    ...
                    result = service.exec("delete from 摩擦系数表 where 编号= %s", (inbh,))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "材料按摩擦系数管理"))
        ...
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\">干燥AVG</p></body></html>"))
