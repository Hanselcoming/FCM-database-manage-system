...
class Ui_MainWindow(QMainWindow):
    ...
    def query(self):
        ...
        result = service.query("select * from 抗高温老化性质表")  # 调用服务类中的公共方法执行查询语句
    ...
    def getName(self, name):
        result = service.query("select * from 抗高温老化性质表 where 编号= %s", name)
        return len(result)
            ...
            if inbh != "":  # 判断编号不为空
                if self.getName(inbh) > 0:
                    ...
                    if service.getName(inbh) == 0:
                        ...
                        result = service.exec(
                            "insert into 抗高温老化性质表(编号,老化D50降级,老化D90降级,老化压后D50降级,老化压后D90降级,级别) values (%s,%s,%s,%s,%s,%s)",
        ...
        try:
            ...
            if inbh != "":  # 判断编号不为空
                if self.getName(inbh) <= 0:
                    ...
                    result = service.exec(
                        "update 抗高温老化性质表 set 老化D50降级=%s,老化D90降级=%s,老化压后D50降级=%s,老化压后D90降级=%s,级别=%s where 编号=%s",
        ...
        try:
            ...
            if inbh != "":
                if self.getName(inbh) <= 0:  # 判断编号是否存在
                    ...
                    result = service.exec("delete from 抗高温老化性质表 where 编号= %s", (inbh,))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "材料按抗高温能力管理"))
        self.label_2.setText(_translate("MainWindow",
                                        "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt;\">编号</span></p></body></html>"))
        self.label_3.setText(
            _translate("MainWindow", "<html><head/><body><p align=\"center\">老化D50降级</p></body></html>"))
        self.label_4.setText(
            _translate("MainWindow", "<html><head/><body><p align=\"center\">老化D90降级</p></body></html>"))
        self.label_5.setText(
            _translate("MainWindow", "<html><head/><body><p align=\"center\">老化压后D50降级</p></body></html>"))
        self.label_6.setText(
            _translate("MainWindow", "<html><head/><body><p align=\"center\">老化压后D90降级</p></body></html>"))
